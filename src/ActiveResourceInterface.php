 ...
 * @since 2.0
 */
interface ActiveResourceInterface extends StaticInstanceInterface
{
    /**
    ...
    /**
     * Creates an [[ActiveResourceQueryInterface]] instance for query purpose.
     *
     * The returned [[ActiveResourceQueryInterface]] instance can be further customized by calling
     * methods defined in [[ActiveResourceQueryInterface]] before `one()` or `all()` is called to return
     ...
     *
     * @return ActiveResourceQueryInterface the newly created [[ActiveResourceQueryInterface]] instance.
     */
    public static function find();
     ...
     *
     * That this method will automatically call the `one()` method and return an [[ActiveResourceInterface|ActiveRecord]]
     * instance.
     *
     ...
     *
     * This method will automatically call the `all()` method and return an array of [[ActiveResourceInterface|ActiveRecord]]
     * instances.
     *
     * > Note: As this is a short-hand method only, using more complex conditions, like ['!=', 'id', 1] will not work.
     * > If you need to specify more complex conditions, use [[find()]] in combination with [[ActiveQuery::where()|where()]] instead.
     ...
     * A relation is defined by a getter method which returns an object implementing the [[ActiveResourceQueryInterface]]
     ...
     * @return mixed the httpclient connection used by this AR class.
     */
